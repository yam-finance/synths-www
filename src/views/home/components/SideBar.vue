<template>
        <aside
            class="sticky justify-center w-64 top-12 overflow-hidden bg-navy-blue-100 dark:bg-black-500 dark:text-gray-100 text-left font-semibold bg-main txt-main invisible md:visible"
        ...
        >
            ...
            <div class="w-full h-12 py-3 px-3 flex">
                ...
                <input
                    class="flex flex-wrap placeholder-gray-500 fo px-10 py-4 h-full w-full focus:text-gray-300 dark:focus:text-gray-300 bg-dark rounded-full outline-none"
            ...
            <ul class="w-full py-4">
                ...
                >
                    <div class="px-4 py-2 my-auto flex border-b border-gray-700 cursor-pointer" :class="menu.active==1? 'bg-light': ''">
