    ...
    >
      <router-link to="/">
        <div class="w-64 h-12 flex">
          ...
          <span class="bg-[#3468FF] my-auto px-2 overflow-hidden ml-3 md:ml-16 rounded-full text-sm"
            >v 3.0</span
          >
        </div>
      </router-link>
    ...
    <div class="container-fluid max-w-[1000px] m-auto">
      <div class="home-content text-center text-white mt-16">
        ...
        <div class="text-lg md:text-xl lg:text-2xl text-[#CBCBFF] m-8 sm:mx-40">
          Yam Synths’ LSP* contracts enable easy minting and low risk leverage on all sorts of
          Synths.
        </div>
        <div class="text-sm txt-main m-8">*Long & Short Position</div>
        ...
        <div class="m-8 text-2xl lg:text-3xl font-semibold">Hedge, trade or earn on our synths</div>
        ...
        <router-link to="/explore-synths">
          <button
            class="hover:shadow-lg rounded-xl px-4 py-2 my-auto text-base font-bold wallet-btn"
          >
            Explore Synths
          </button>
        </router-link>
        ...
        <div class="mx-20 md:mx-10 lg:mx-40 font-semibold">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div
              class="card rounded-lg bg-[#272760] px-4 sm:px-16 py-4 flex flex-col min-h-[224px]"
            >
              <div class="mt-auto">
          ...
          >
            <div class="mt-auto">
              ...
              <p class="text-lg leading-6 sm:mx-20">
