    ...
    <div class="grid grid-cols-1 2xl:grid-cols-2 border-b bd-main">
      <div class="px-6 py-4 border-r bd-main">
        ...
        <p class="text-[#CBCBFF] mt-8">
          Sushi APY Long and Short tokens track an index consisting of ten stocks that are most
          commented on r/wallstreetbets. The initial Index constituents are selected based on data
          from swaggystocks.com.
        </p>
      ...
      <div class="border-t bd-main">
        ...
        <div class="w-full text-white border-t bd-main">
          <div v-for="(option, key) in options" :key="key" @click="selected_option = option.id">
            <div
      ...
      <div class="grid grid-cols-1 xl:grid-cols-2">
        <div class="px-6 py-4 pb-8 border-r border-b bd-main">
          ...
          <p class="text-sm txt-main pb-8">
            Simulate your potential returns at expiry. Edit the number of short or long tokens in
            your wallet. with the chart to see your expected profit or loss
          </p>
