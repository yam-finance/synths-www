    ...
    <div class="bg-opacity-30 backdrop-blur-lg flex items-center justify-center fixed inset-0" @click="emits('close')">
        <div class="rounded-lg flex flex-col items-start shadow-2xl p-4 absolute w-[340px] bg-[#252562] shadow-xl">
            <div class="justify-between font-semibold text-base leading-5 relative text-white not-italic pt-0">
                ...
                <div class="flex-none order-1 text-sm mx-0 mt-0.5 font-normal static not-italic text-purpleLighter">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur volutpat, felis ac posuere
                    bibendum, augue velit facilisis nisl, eget lobortis dolor magna nec ante. Sed sit amet felis est.
                </div>
            </div>

            <s-button button-styles="wallet-btn px-4 py-3 my-2 text-sm font-semibold mr-4">
                <template #buttonTitle> Start Simulation </template>
            </s-button>
            ...
            >
                <router-link to="#">
                    ...
                    <span class="inline-flex text-white"> &nbsp;<external-link-svg class="w-[12px] h-[12px]" /> </span>
                </router-link>
            </div>
        </div>
    </div>
