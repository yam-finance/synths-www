<template>
  ...
  >
    ...
    <ul
      class="flex md:space-x-2 lg:space-x-8 overflow-hidden sticky left-64 my-auto px-4 rounded-full  mx-4 py-1 font-semibold bg-dark txt-main invisible md:visible"
    >
      <li
